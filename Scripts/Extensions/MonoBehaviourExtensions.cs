...
namespace FishingCactus
{
    ...
    {
        public static void SetParent( this MonoBehaviour monobehaviour, Transform parent, bool reset_local_position = true, bool reset_local_rotation = true, bool reset_local_scale = false )
        {
